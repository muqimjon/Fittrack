...
namespace FTS.View.GenericView;

public class GenericView<TCreate, TUpdate, TResult, TService>
    where TCreate : class, new()
    where TUpdate : class, new()
    where TResult : class
    where TService : IServiceInterface<TCreate, TUpdate, TResult>
{
    private readonly TService service; // TService ni saqlash uchun o'zgaruvchi

    public GenericView(TService service)
    {
