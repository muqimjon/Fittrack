...
using TCreate = FTS.Service.DTOs.ProgressRecordCreationDto;
using TUpdate = FTS.Service.DTOs.ProgressRecordUpdateDto;
using TResult = FTS.Service.DTOs.ProgressRecordResultDto;
using TService = FTS.Service.Services.ProgressRecordService;

namespace FTS.View.ViewServices;

public class ProgressRecordView
{
    private readonly TService service;

    public ProgressRecordView()
    {
