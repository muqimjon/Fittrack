...
using TCreate = FTS.Service.DTOs.NuritionPlanCreationDto;
using TUpdate = FTS.Service.DTOs.NuritionPlanUpdateDto;
using TResult = FTS.Service.DTOs.NuritionPlanResultDto;
using TService = FTS.Service.Services.NuritionPlanService;

namespace FTS.View.ViewServices;

public class NuritionPlanView
{
    private readonly TService service;

    public NuritionPlanView()
    {
