...
using TCreate = FTS.Service.DTOs.UserCreationDto;
using TUpdate = FTS.Service.DTOs.UserUpdateDto;
using TResult = FTS.Service.DTOs.UserResultDto;
using TService = FTS.Service.Services.UserService;
